...
export default function App() {
  ...
  useEffect(() => {
    const init = async () => {
      ...
      if (tg?.initDataUnsafe?.user) {
        ...
        tg.ready();
        tg.expand();
        // Авто-логин в PocketBase при запуске WebApp
  ...
  // остальная часть файла (SPLASH/AUTH/LOCATION/ACCOUNT_TYPE/MAIN) оставлена без изменений
  // ...
}
