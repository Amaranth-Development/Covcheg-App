...
const allCategories = [
  ...
  { id: 'bus', name: 'BUS', icon: 'Bus', color: 'bg-blue-600' },
  { id: 'rent', name: 'RENT', icon: 'Key', color: 'bg-indigo-600' },
  ...
  { id: 'jobs', name: 'WORK', icon: 'Briefcase', color: 'bg-indigo-500' },
  { id: 'business', name: 'BUSINESS', icon: 'Building2', color: 'bg-slate-700' },
  { id: 'ai', name: 'AI-HELP', icon: 'Bot', color: 'bg-red-500' },
